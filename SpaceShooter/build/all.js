...
(function (SpaceShooter) {
    ...
    SpaceShooter.PARTICLE_COUNT = 500;
...
(function (SpaceShooter) {
    var MenuController = (function (_super) {
        ...
        function MenuController(stage) {
            ...
            var title = new SpaceShooter.DecoratedText('Space Shooter');
    ...
    var SplashController = (function (_super) {
        ...
        function SplashController(stage) {
            ...
            animation.onComplete = function () {
                var text = new SpaceShooter.DecoratedText('Space Shooter');
...
(function (SpaceShooter) {
    var Animation = (function (_super) {
        ...
        function Animation() {
            ...
            var textureArray = [];
            for (var i = 0; i < 7; i++) {
                var texture = PIXI.Texture.fromImage('../../resources/images/animation/wormhole' + i + '.png');
